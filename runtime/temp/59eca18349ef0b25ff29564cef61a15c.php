...
<a href="<?php echo url('index/about/link'); ?>" id="abtoulianxi">联系我们</a>
        ...
        <div id="newslist">
            ...
            <div class="pro mainbox-shadow">
                <a href="<?php echo url('index/Article/info',['id'=>$vo['id']]); ?>"><img src="<?php echo $vo['pic']; ?>" alt="" width="318" height="247"></a>
                <article>
                    <h3><a href="<?php echo url('index/Article/info',['id'=>$vo['id']]); ?>"><?php echo $vo['title']; ?></a></h3>
