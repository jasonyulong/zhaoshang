<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\www\zhaoshang\application\..\public\tpl\user\index\index.html";i:1541749573;s:44:"D:\www\zhaoshang\public\tpl\user\layout.html";i:1542251356;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
    ...
    <div id="main">
        ...
        <section style="padding: 30px 15px 0px 15px;display: flex">
            <div class="setingleft">
                ...
                <a href="<?php echo url('user/index/index'); ?>" class="p-link active">信息修改</a>
                <a href="<?php echo url('user/index/face'); ?>" class="p-link ">头像设置</a>
            </div>
            <div class="setingrigth">
                <p><span></span><strong>个人设置</strong></p>

                <form id="edit" method="post">
                    <div class="form-group">
                        <label><span>电</span><span>子</span><span>邮</span><span>件:</span></label>
                        <div><input type="text" name="email" value="<?php echo $info['email']; ?>"></div>
                    </div>
                    <div class="form-group">
                        <label><span>真</span><span>实</span><span>姓</span><span>名:</span></label>
                        <div><input type="text" name="nk_name" value="<?php echo $info['nk_name']; ?>"></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label><span>年</span><span>龄</span></label>
                        <div class="selectFater">
                            <div class="select">
                    ...
                    <div class="form-group">
                        <label><span>出</span><span>生</span><span>地:</span></label>
                        <div class="selectFater">
                            <div class="select" >
                    ...
                    <div class="form-group">
                        <label><span>行</span><span>业:</span></label>
                        <div class="selectFater">
                            <div class="select">
                    ...
                    <div class="form-group">
                        <label><span>意</span><span>向</span><span>需</span><span>求:</span></label>
                        <div class="selectFater">
                            <div class="select" >
                    ...
                    <div class="form-group" style="margin: 60px 0 100px 0">
                        <label></label>
                        <input type="submit" value="确认" style="">
                    </div>
                </form>
            </div>
        </section>
...
<script>
    $("#edit").validate({
        ...
        rules:{
            ...
            nk_name:{required: true,maxlength: 4},
            sex:{required:true},
            year:{required:true},
            month:{required:true},
            day:{required:true},
        ...
        messages:{
            name:{required:"昵称不能为空",maxlength:"昵称最大长度为{0}"},
            nk_name:{required: "真实姓名不能为空",maxlength:"真是姓名最大长度为{0}"},
            sex:{required:"请选择性别"},
            year:{required:"请选择年份"},
            month:{required:"请选择月份"},
            day:{required:"请选择日期"},
            province:{required:"请选择出生地点"},
            city:{required:"请选择出生城市"},
            job:{required:"请选择从事行业"},
            need:{required:"请选择需求"}
        }
    })
</script>
...
<script>
    ...
    $(document).ready(function(){
        setTimeout(function(){
            $('#province').val("<?php echo $info['province']; ?>")
            $('#province').trigger("change")

            $('#city').val("<?php echo $info['city']; ?>")

            $("#year").val("<?php echo $info['year']; ?>")
            $("#year").trigger("change")
            $("#month").val("<?php echo $info['month']; ?>")
            $("#month").trigger("change")
            $("#day").val("<?php echo $info['day']; ?>")

            $("#sex").val("<?php echo $info['sex']; ?>")
            $("#job").val("<?php echo $info['job']; ?>")
            $("#need").val("<?php echo $info['need']; ?>")
        },500)
