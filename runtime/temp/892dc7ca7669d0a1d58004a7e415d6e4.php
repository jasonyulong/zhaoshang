...
<a href="<?php echo url('index/zhaoshang/friend'); ?>" id="zhaoshang_friend">合作名企</a>
        ...
        <div id="tudi" class="mainbox-shadow">
            ...
            <div>
                ...
                <h2><strong><?php echo $info['area']; ?></strong>亩</h2>
                <h3><?php echo $info['pro']; ?>-<?php echo $info['city']; ?></h3>
                <div><span class="key">土地行业: </span><span class="value"><?php echo $info['hangye']; ?></span><span class="key">方式：</span><span class="value"><?php echo $info['fangshi']; ?></span></div>
                <div><span class="key">土地租金：</span><span class="value"><?php echo $info['zujing']; ?>元</span><span class="key">使用年限：</span><span class="value"><?php echo $info['year']; ?>年</span></div>
                <div><span class="key">土地性质：</span><span class="value"><?php echo $info['xingzhi']; ?></span><span class="key">土地证：</span><span class="value"><?php echo $info['zheng']; ?></span></div>
            </div>
        </div>
