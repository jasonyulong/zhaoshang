<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/opt/web/zhaoshang/application/../public/tpl/index/index/index.html";i:1565855111;s:47:"/opt/web/zhaoshang/public/tpl/index/layout.html";i:1551321340;s:34:"../public/tpl/index/allfooter.html";i:1551321004;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="description" content="招商政策网是服务于全国各省市、区、县招商引资和项目对接的综合性招商网站。为地方政府和企业搭建合作的纽带。">
    <meta name="keywords" content="招商网,总部经济,实体招商">
...
<title>招商政策网-招商引资|政府招商|政策动态|招商信息|实体招商|产业园招商</title>
...
<aside id="mainaside" class="position-fixed" style="width: 65px;right: 0px">
    <!--<a href="<?php echo url('index/index/404'); ?>" class="text-white d-block d-flex flex-column justify-content-around" style="width: 65px;height: 65px;margin-bottom: 1px">
   ...
   <!-- <a href="<?php echo url('index/index/404'); ?>" class="text-white d-block " style="width: 65px;height: 65px;margin-bottom: 1px">
        <p class="m-0 pt-1 iconfont font-size-24 text-center">&#xe63d;</p>
    ...
    <a href="tencent://message/?uin=52203910&amp;Site=http://vps.shuidazhe.com&amp;Menu=yes" class="text-white d-block position-relative" style="width: 65px;height: 65px;margin-bottom: 1px">
        ...
        <article class=" justify-content-center align-items-center flex-column bg-white pt-3" style="position: absolute;right: 65px;top: 0px;border: 2px solid #dd0000;width: 110px;height: 129px;z-index: 1000" >
            <div class="d-flex justify-content-center">
                <img  src="/images/newzs/img/zixun.png" width="84" height="84" class="d-block  tp-4 " alt="图片">
            </div>
        ...
        <div class="col-6 px-5" id="searchbox">
            ...
            <form method="get" action="<?php echo url('index/index/search'); ?>">
                <div class="input-group " style="height: 56px">
                    ...
                    <input name="title" type="search" id="search" autocomplete="off" class="form-control rounded-0 h-100 border-left-0" >
...
<nav id="nav" class="container bg-linered d-flex justify-content-around  position-relative align-items-center " style="max-width: 1200px;margin-top: 145px;margin-bottom: 20px;height: 75px">
    ...
    <div class="navhover h-100">
        <a href="/hcy/" class="text-white font-size-18 font-weight-light h-100 d-block px-3" style="line-height: 75px">税务筹划</a>
    </div>
    <div class="navhover h-100">
        <a href="<?php echo url('index/zc/bg'); ?>" class="text-white font-size-18 font-weight-light h-100 d-block px-3" style="line-height: 75px">政策动态</a>
      <!--  <div class="secondnav position-absolute   col-12" >
            <div class="col-12 " style="padding-left: 200px">
    ...
    <div class="navhover h-100">
        <a href="/zht/" class="text-white font-size-18 font-weight-light h-100 d-block px-3" style="line-height: 75px">综合体</a>
        <!--<div class="secondnav position-absolute   col-12" >
            <div class="col-12 " style="padding-left: 200px">
                <a href="<?php echo url('index/index/404'); ?>" class="text-333 mr-5">孵化器</a>
                <a href="<?php echo url('index/index/404'); ?>" class="text-333 mr-5">众创空间</a>
                <a href="<?php echo url('index/index/404'); ?>" class="text-333 mr-5">商业综合体</a>
            </div>
        </div>-->
    </div>
    <div class="navhover h-100">
        <a href="<?php echo url('index/zc/dj'); ?>" class="text-white font-size-18 font-weight-light h-100 d-block px-3" style="line-height: 75px">项目对接</a>
      <!--  <div class="secondnav position-absolute   col-12" >
            <div class="col-12 " style="padding-left: 200px">
    ...
    <div class="navhover h-100">
        <a href="<?php echo url('index/index/404'); ?>" class="text-white font-size-18 font-weight-light h-100 d-block px-3" style="line-height: 75px">行政办公</a>
    </div>

    <div class="navhover h-100">
        <a href="<?php echo url('index/chouhua/zhaoshang'); ?>" class="text-white font-size-18 font-weight-light h-100 d-block px-3" style="line-height: 75px">特色项目</a>
       <!-- <div class="secondnav position-absolute   col-12" >
            <div class="col-12 "  style="padding-left: 200px">
                <a href="<?php echo url('index/index/404'); ?>" class="text-333 mr-5 ">工业</a>
                <a href="<?php echo url('index/index/404'); ?>" class="text-333 mr-5">农业</a>
                <a href="<?php echo url('index/index/404'); ?>" class="text-333 mr-5">AI</a>
                <a href="<?php echo url('index/index/404'); ?>" class="text-333 mr-5">特色小镇</a>
            </div>
        </div>-->
    </div>
    ...
    <div class="row h-100">
        ...
        <div class="col h-100 align-content-between d-flex flex-column justify-content-between" style="padding: 0 10px; ">
            <div class="row align-items-center">
                ...
                <div class="col-6 text-right align-item--center"><a href="<?php echo url('index/zc/bg'); ?>" class="text-red font-size-14">更多&gt;</a></div>
            </div>
            <div class="row">
                <div class="col-12 ">
        ...
        <div class="col-8">
            ...
            <div class="row">
                ...
                <div class="col-4 text-right justify-content-center d-flex flex-column">
                    <a href="<?php echo url('index/zc/bg'); ?>" class="text-red font-size-14 line-height-35">更多&gt;</a>
                </div>
            </div>
            ...
            <div class="row" >
                <div class="col-12 d-flex flex-column  justify-content-between " id="nav-xz">
                    ...
                    <div class="row  "style="padding: 0 30px;margin: 0 -10px;" >
                        ...
                        <div class="col-4  text-center " style="padding: 0 5px;">
                            <div  data-toggle="modal" data-target="#contentusmodal" class="w-100 d-block bg-red text-white py-2 cursor-pointer font-size-14">入园申请</div>
                        </div>
                    </div>
...
<div class="container mb-50" style="max-width: 1230px;">
    <div class="row">
        <div class="col-12">
            <div class="border-red w-100"></div>
            <div class="row">
            ...
            <div class="row" >
                <div class="col-12 ">
                    <div class="tab-content " role="tablist">
                        <div class="tab-pane   fade show active" id="block5" >
                            <div class="row "  style="margin: 0 -25px">
                                ...
                                <div class="col-3  " style="padding: 0 25px">
                                    <div class="w-100  d-flex flex-column mb-4 justify-content-between" style="height: 390px" >
                        ...
                        <div class="tab-pane   fade " id="block6" >
                            <div class="row "  style="margin: 0 -25px">
                                <?php if(is_array($zs_fang) || $zs_fang instanceof \think\Collection || $zs_fang instanceof \think\Paginator): $i = 0; $__LIST__ = $zs_fang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <div class="col-3  " style="padding: 0 25px">
                                    <div class="w-100  d-flex flex-column mb-4 justify-content-between" style="height: 390px" >
                        ...
                        <div class="tab-pane   fade " id="block7" >
                            <div class="row "  style="margin: 0 -25px">
                        ...
                        <div class="tab-pane   fade " id="block8" >
                            <div class="row "  style="margin: 0 -25px">
                ...
                <div class="tab-pane  h-100 fade show active" id="block9" >
                    <div class="row h-100"  >
                        ...
                        <div class="col-4 h-100 flex-column  d-flex" >
                            <a href="<?php echo url('index/zc/newsinfo',['id'=>$vo['id']]); ?>" class="link-overflow d-block"> <img src="<?php echo $vo['pic']; ?>" width="380" height="197" alt="<?php echo $vo['title']; ?>"></a>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-4 text-right justify-content-center d-flex flex-column"><a href="<?php echo url('chouhua/zhaoshang'); ?>" class="text-red font-size-14 ">更多&gt;</a></div>
            </div>
            <div class="row" style="">
                <div class="col-12">
                                    ...
                                    <div class="row h-100"  style="max-width: 1246px;margin: 0 -23px">
                                        ...
                                        <div class="col-4 h-100 flex-column justify-content-between d-flex"  style="padding: 0 23px">
                                            <a href="#" class="d-block position-relative">
                                                <img  src="<?php echo $vo['pic']; ?>" width="100%" height="193" alt="图片"/>
...
<div class="modal fade" id="contentusmodal">
    <div class="modal-dialog">
        <form action="<?php echo url('index/index/msg'); ?>" method="post" class="modal-content" id="formdata">
            <div class="modal-header">
                <h5 class="modal-title text-red ">由于各地政策差异,将根据您所在的城市30分钟内提供详细报价</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend ">
                            <div class="input-group-text ">所在地址</div>
                        </div>
                        <input type="text" class="form-control" name="所在地址" autocomplete="off" required placeholder="如:湖北省武汉市硚口区宝善街23号">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">联系电话</div>
                        </div>
                        <input type="text" class="form-control" name="联系电话" placeholder="请输入您的联系电话">
                    </div>
                </div>
                <div class="errormsg"></div>
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">联&nbsp;系&nbsp;人&nbsp;</div>
                        </div>
                        <input type="text" class="form-control" name="联系人" placeholder="如:吴先生">
                    </div>
                </div>
                <div class="errormsg"></div>
                <div class="form-group">
                    <input type="submit" class="btn btn-block bg-red text-white" value="提交">
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $('#formdata').validate({
            ...
            rules: {
                所在地址: {required: true,maxlength:50},
                联系电话: {required: true,maxlength:20,number:true},
                联系人: {required: true,maxlength:20},
            },
            messages: {
                所在地址: {
                    required: "请输入地址",
                ...
                联系电话: {required: "请输入联系方式",maxlength:"最大字符数为{0}",number:"电话号码由数组组成"},
                联系人: {required: "请填写联系人",maxlength:"最大字符数为{0}"},
            }
        })
    })
</script>
