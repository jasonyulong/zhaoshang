<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/opt/web/zhaoshang/application/../public/tpl/admin/article/sort_index.html";i:1546409461;s:47:"/opt/web/zhaoshang/public/tpl/admin/layout.html";i:1547602823;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-form news_list">
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-name"><img src="/images/folder-yellow-32.png"><?php echo $vo['name']; ?><?php echo( db('Article')->where('sort='.$vo["id"])->count() ); ?>条</td>
            <td>
        ...
        <tr>
            ...
            <td class="td-name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/folder-yellow-32.png"><?php echo $z['name']; ?><?php echo( db('Article')->where('sort='.$z["id"])->count() ); ?>条</td>
            <td>
        ...
        <tr>
            ...
            <td class="td-name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/folder-yellow-32.png"><?php echo $y['name']; ?><?php echo( db('Article')->where('sort='.$y["id"])->count() ); ?>条</td>
            <td>
