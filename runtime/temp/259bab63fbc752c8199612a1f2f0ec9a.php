<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\www\zhaoshang\application\..\public\tpl\admin\da\add.html";i:1542328924;s:45:"D:\www\zhaoshang\public\tpl\admin\layout.html";i:1528875057;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" method="post" enctype="multipart/form-data">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="title" class="layui-input linksName" lay-verify="required" placeholder="请输入名称">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">地址</label>
        <div class="layui-input-block">
            <input type="tel" name="url" class="layui-input linksUrl" lay-verify="required|url" placeholder="请输入地址">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="cate" class="isselect" style="display: block;">
