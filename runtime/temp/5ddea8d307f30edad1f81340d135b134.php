<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\www\zhaoshang\application\..\public\tpl\admin\zheng\edit.html";i:1541727759;s:45:"D:\www\zhaoshang\public\tpl\admin\layout.html";i:1528875057;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" method="post" enctype="multipart/form-data" id="form" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="guimo" placeholder="万元" value="<?php echo $info['guimo']; ?>">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="qiye" placeholder="家" value="<?php echo $info['qiye']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">发展环境</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="huanjing"><?php echo $info['huanjing']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">优惠政策</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="zhengche"><?php echo $info['zhengche']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">地理优势</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="dili"><?php echo $info['dili']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">企业风采</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="fengcai"><?php echo $info['fengcai']; ?></textarea>
        </div>
    </div>
