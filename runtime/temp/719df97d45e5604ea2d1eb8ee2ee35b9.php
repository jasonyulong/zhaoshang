...
<a href="<?php echo url('index/about/link'); ?>" id="abtoulianxi">联系我们</a>
        ...
        <div id="about-guimo">
            <img src="/images/zhaoshang//img/shitizhaoshang/55.jpg" alt="">
            <p>历经十载发展，业务覆盖领域由深圳逐渐分布至东莞、惠州、广州、佛山、中山、江门、上海、武汉、南京、郑州、成都、长沙等地，已成为中国领先的产业地产服务商</p>
        </div>
