<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\www\zhaoshang\application\..\public\tpl\user\cang\lou.html";i:1541991698;s:44:"D:\www\zhaoshang\public\tpl\user\layout.html";i:1542251356;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
    ...
    <div id="main">
        ...
        <section style="padding: 30px 15px 0px 15px;display: flex">
            <div class="setingleft">
                ...
                <a href="<?php echo url('user/cang/lou'); ?>" class="p-link active ">写字楼收藏</a>
            </div>
            <div class="setingrigth" style="background-color: white">

                <p><span></span>关注的写字楼</p>
                <!--如果还没关注的类容-->
