...
<a href="<?php echo url('index/teshe/index'); ?>"  id="tslink4"><img src="/images/zhaoshang/img/shitizhaoshang/40.png" alt=""><h1>特色小镇</h1></a>
        ...
        <div id="ts-main">
            <div class="title">
                ...
                <a href="<?php echo url('index/teshe/news'); ?>">more</a>
            </div>
            <div class="ts-project">
                    ...
                    <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item <?php if($k == '1'): ?>active<?php endif; ?>">
                                <a href="<?php echo url('index/chouhua/newsinfo',['id'=>$vo['id']]); ?>"><img src="/images/zhaoshang/img/shitizhaoshang/40.jpg" width="390" height="272" alt="First slide"></a>
                ...
                <div class="ts-newlist">
                    <section>
                        <h3><span>推荐新闻</span><a href="<?php echo url('index/teshe/news'); ?>">更多</a></h3>
                    ...
                    <section>
                        <h3><span>热点新闻</span><a href="<?php echo url('index/teshe/news'); ?>">更多</a></h3>
                ...
                <div class="ts-newlist">
                    <section>
                        <h3><span>最新新闻</span><a href="<?php echo url('index/teshe/news'); ?>">更多</a></h3>
            ...
            <div class="title">
                ...
                <a href="<?php echo url('index/chouhua/zhaoshang'); ?>">more</a>
            </div>
            <div class="anli">
                <div class="flex">
                    <?php if(is_array($zhengpin) || $zhengpin instanceof \think\Collection || $zhengpin instanceof \think\Paginator): $i = 0; $__LIST__ = $zhengpin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            ...
            <div class="jianshe">
                <a href="<?php echo url('index/teshe/news',['sort'=>27]); ?>">
                    <div class="imgbox" style="background-color: #dd3232">
                        <img src="/images/zhaoshang/img/shitizhaoshang/43.png" alt="">
                    </div>
                    <div>
                        <h4>小镇简介</h4>
                        <p>关于小镇简介</p>
                ...
                <a href="<?php echo url('index/teshe/news',['sort'=>28]); ?>">
                    <div class="imgbox" style="background-color: #62cf9f">
                        <img src="/images/zhaoshang/img/shitizhaoshang/44.png" alt="">
                    </div>
                    <div>
                        <h4>政策解读</h4>
                        <p>关于小镇简介</p>
                ...
                <a href="<?php echo url('index/teshe/news',['sort'=>29]); ?>">
                    <div class="imgbox" style="background-color: #ebb541">
                        <img src="/images/zhaoshang/img/shitizhaoshang/45.png" alt="">
                    </div>
                    <div>
                        <h4>小镇打造</h4>
                        <p>关于小镇简介</p>
                ...
                <a href="<?php echo url('index/teshe/news',['sort'=>30]); ?>">
                    <div class="imgbox" style="background-color: #7f46d5">
                        <img src="/images/zhaoshang/img/shitizhaoshang/46.png" alt="">
                    </div>
                    <div>
                        <h4>小镇运营</h4>
                        <p>关于小镇简介</p>
                ...
                <a href="<?php echo url('index/teshe/news',['sort'=>31]); ?>">
                    <div class="imgbox" style="background-color: #458ef1">
                        <img src="/images/zhaoshang/img/shitizhaoshang/47.png" alt="">
                    </div>
                    <div>
                        <h4>小镇运营</h4>
                        <p>关于小镇简介</p>
            ...
            <div class="anli">
                <div class="flex">
                    <?php if(is_array($zhenganli) || $zhenganli instanceof \think\Collection || $zhenganli instanceof \think\Paginator): $i = 0; $__LIST__ = $zhenganli;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <a href="<?php echo url('index/chouhua/zheng',['id'=>$vo['id']]); ?>">
                        <img src="<?php echo $vo['pic']; ?>" width="260" height="168" alt="">
                        <h4><?php echo $vo['title']; ?></h4>
                    </a>
