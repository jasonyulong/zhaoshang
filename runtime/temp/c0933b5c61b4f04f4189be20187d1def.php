<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\www\zhaoshang\application\..\public\tpl\index\hcy\fuwu.html";i:1545275997;s:42:"D:\www\zhaoshang\public\tpl\index\hcy.html";i:1545272364;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<!--banner-->
<div id="banner" class="container-fluid p-0 mt-3 position-relative d-flex align-items-center" style="background-image: url(/images/hcy/img/6.jpg)" >
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-5 d-flex align-items-center text-white justify-content-end ">
                <span class="font-size-55 mr-2 text-uppercase font-weight-light line-height-55" >s</span><span class="font-size-24 mr-2 text-uppercase font-weight-light">ervice</span><span ><img src="/images/hcy/img/9.png" alt=""></span>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-5 d-flex align-items-center text-white justify-content-start ">
                <span class="mr-2"><img src="/images/hcy/img/9.png" alt=""></span><span class="font-size-36 mr-2 line-height-36 font-weight-light" >服务项目</span><span class="font-size-24 mr-2 text-uppercase align-self-end line-height-24 font-weight-light"  >items</span>
            </div>
        </div>
    </div>s
</div>
<div class="container mb-4" style="max-width: 1230px">
    <div class="row">
        <div class="col" id="mianbao" >
            <p class="my-3 text-666"><a href="<?php echo url('index/hcy/index'); ?>"><span class="iconfont icon-shouye mr-1 "></span>首页</a> &nbsp;&gt;&nbsp;服务项目</p>
        </div>
    </div>
</div>
<div class="container" style="margin-bottom: 100px">
    <div class="row fuwu my-5">
        <div class="col-2 d-flex align-items-center justify-content-center">
            <span class="iconfont font-size-55 icon-cloud-seal text-white " ></span>
        </div>
        <div class="col-10 d-flex flex-column align-content-between justify-content-between">
            <div class="row ">
                <div class="col-auto font-size-36 text-red p-0 line-height-36  font-weight-light" >工商服务</div>
                <div class="col font-size-16 text-uppercase text-333 line-height-16 d-flex align-content-between flex-column justify-content-between">
                    <article class="text-uppercase" >Business </article>

                    <article class="text-uppercase">services</article>
                </div>
            </div>
            <div class="row">工商注册、核名、营业执照、刻章、银行开户、工商变更</div>
        </div>
    </div>
    <div class="row fuwu my-5">
        <div class="col-2 d-flex align-items-center justify-content-center">
            <span class="iconfont font-size-55 icon-qian2 text-white" ></span>
        </div>
        <div class="col-10 d-flex flex-column align-content-between justify-content-between">
            <div class="row ">
                <div class="col-auto font-size-36 text-red p-0 line-height-36 font-weight-light" >财税服务</div>
                <div class="col font-size-16 text-uppercase text-333 line-height-16 d-flex align-content-between flex-column justify-content-between">
                    <article class="text-uppercase">Finance and taxation </article>
                    <article class="text-uppercase">service</article>
                </div>
            </div>
            <div class="row">代理记账、纳税申报、税务年报、发票托管、税收方案定制、税务筹划</div>
        </div>
    </div>
    <div class="row fuwu my-5">
        <div class="col-2 d-flex align-items-center justify-content-center">
            <span class="iconfont font-size-55 icon-zizhi text-white" ></span>
        </div>
        <div class="col-10 d-flex flex-column align-content-between justify-content-between">
            <div class="row ">
                <div class="col-auto font-size-36 text-red p-0 line-height-36 font-weight-light " >资质代理</div>
                <div class="col font-size-16 text-uppercase text-333 line-height-16 d-flex align-content-between flex-column justify-content-between">
                    <article class="text-uppercase">Qualification </article>
                    <article class="text-uppercase">agency</article>
                </div>
            </div>
            <div class="row text-uppercase">icp、sp、isp、游戏资质审批、代理公司注册有保障</div>
        </div>
    </div>
    <div class="row fuwu my-5">
        <div class="col-2 d-flex align-items-center justify-content-center">
            <span class="iconfont font-size-55 icon-che text-white" ></span>
        </div>
        <div class="col-10 d-flex flex-column align-content-between justify-content-between">
            <div class="row ">
                <div class="col-auto font-size-36 text-red p-0 line-height-36 font-weight-light " >接待服务</div>
                <div class="col font-size-16 text-uppercase text-333 line-height-16 d-flex align-content-between flex-column justify-content-between">
                    <article class="text-uppercase">Reception</article>
                    <article class="text-uppercase">service</article>
                </div>
            </div>
            <div class="row">专人专车机场接送,业务办理全流程陪同,免费提供高端住宿</div>
        </div>
    </div>
</div>
