<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\www\zhaoshang\application\..\public\tpl\index\zhaoshang\fabu.html";i:1542613920;s:41:"D:\www\zhaoshang\public\tpl\index\zs.html";i:1542253052;s:36:"../public/tpl/index/include_nav.html";i:1542265791;s:31:"../public/tpl/index/zs_nav.html";i:1542594492;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<a href="<?php echo url('index/zhaoshang/friend'); ?>" id="zhaoshang_friend">合作名企</a>
        ...
        <form id="form" method="post">
            ...
            <nav>
                <a href="<?php echo url('index/zhaoshang/fabu',['type'=>$type]); ?>" class="active"><span>免费发布<?php echo $type_ch; ?></span></a>
                <a href="<?php echo url('index/zhaoshang/xuqiu',['type'=>$type]); ?>"><span>登记<?php echo $type_ch; ?>需求</span></a>
            </nav>
            ...
            <div class="form-group">
                ...
                <div class="value">
                    <input name="name" type="text" required="true" maxlength="20"  autocomplete="off">
                </div>
            </div>
            <div class="errormsg"></div>
            <div class="form-group">
                ...
                <div class="value">
                    <input name="tel" type="text" required="true"  autocomplete="off">
                </div>
            </div>
            <div class="errormsg"></div>
            <div class="form-group">
            ...
            <div class="errormsg"></div>
            <div class="form-group">
                <div class="name" ><span>详情说明：</span></div>
                <div class="value">
                    <textarea name="des" maxlength="200"></textarea>
                </div>
            </div>
            <div class="errormsg"></div>
            ...
            <div class="form-group">
                ...
                <div class="value">
                    <input name="area" type="text" required="true">亩
                </div>
            </div>
            <div class="errormsg"></div>
            <div class="form-group">
                ...
                <div class="value">
                    <div class="radiobox">
                        <input type="radio" checked name="fangshi" value="出租" id="zu" >
                        <label for="zu">出租</label>
                    </div>
                    <div class="radiobox">
                        <input type="radio" name="fangshi" value="出售" id="gou">
                        <label for="gou">出售</label>
                    </div>
                </div>
            </div>
            <div class="errormsg"></div>
            <div class="form-group">
                ...
                <div class="value">
                    <input type="text" name="zujing" required="true"><span>元</span>
                </div>
            </div>
            <div class="errormsg"></div>
            <?php endif; if($type_ch == '厂房'): ?>
            <div class="form-group">
                <div class="name"><span><?php echo $type_ch; ?>面积：</span></div>
                <div class="value">
                    <input name="area" type="text" required="true"><span>㎡</span>
                </div>
            </div>
            <div class="errormsg"></div>
            <div class="form-group">
                ...
                <div class="value">
                    <div class="radiobox">
                        <input type="radio" checked name="yixiang" value="出租" id="zu" >
                        <label for="zu">出租</label>
                    </div>
                    <div class="radiobox">
                        <input type="radio" name="yixiang" value="出售" id="gou">
                        <label for="gou">出售</label>
                    </div>
                </div>
            </div>
            <div class="errormsg"></div>
            <div class="form-group">
                <div class="name"><span>适用行业：</span></div>
                <div class="value">
                    <input name="hang" type="text" required="true"  autocomplete="off">
                </div>
            </div>
            <div class="errormsg"></div>
            <?php endif; if($type_ch == '写字楼'): ?>
            <div class="form-group">
                <div class="name"><span><?php echo $type_ch; ?>面积：</span></div>
                <div class="value">
                    <input name="area" type="text" required="true"><span>㎡</span>
