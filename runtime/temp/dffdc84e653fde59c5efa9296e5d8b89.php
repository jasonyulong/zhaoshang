<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\www\zhaoshang\application\..\public\tpl\index\zc\newsinfo.html";i:1545983639;s:43:"D:\www\zhaoshang\public\tpl\index\body.html";i:1546391299;s:34:"../public/tpl/index/allfooter.html";i:1546391299;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container-fluid bg-linered m-0 " style="background:linear-gradient(#ed444b87,#bf181f)">
        <nav id="nav" class="container-fluid   d-flex justify-content-between  align-items-center " style="max-width: 1200px;height: 75px;">
            <div class="navhover h-100">
                <a href="<?php echo url('index/index/index'); ?>" class="text-white font-size-18 h-100 d-block px-4 font-weight-bold font-size-22" style="line-height: 75px">首页</a>
            </div>
            <div class="navhover h-100">
                <a href="#" class="text-white font-size-18 h-100 d-block px-4 " style="line-height: 75px">实体招商</a>
            ...
            <div class="navhover h-100">
                <a href="http://www.i35wang.com/hcy/index.html" class="text-white font-size-18 font-weight-light h-100 d-block px-4" style="line-height: 75px">税务筹划</a>
            </div>
            <div class="navhover h-100">
                <a href="<?php echo url('404'); ?>" class="text-white font-size-18 font-weight-light h-100 d-block px-4 " style="line-height: 75px">政策动态</a>
                <div class="secondnav container-fluid position-absolute  col-12" >
                    <div class="container" style="max-width: 1156px">
                        <div class="col-12 p-0" >
            ...
            <div class="navhover h-100">
                <a href="<?php echo url('404'); ?>" class="text-white font-size-18 font-weight-light h-100 d-block px-4" style="line-height: 75px">综合体</a>
                <div class="secondnav container-fluid position-absolute col-12" >
                    <div class="container" style="max-width: 1156px">
                        <div class="col-12 p-0" >
            ...
            <div class="navhover h-100">
                <a href="<?php echo url('404'); ?>" class="text-white font-size-18 font-weight-light h-100 d-block px-4" style="line-height: 75px">项目对接</a>
                <div class="secondnav container-fluid position-absolute  col-12" >
                    <div class="container" style="max-width: 1156px">
                        <div class="col-12 p-0" >
            ...
            <div class="navhover h-100">
                <a href="#" class="text-white font-size-18 font-weight-light h-100 d-block px-4 " style="line-height: 75px">行政办公</a>
                <div class="secondnav container-fluid position-absolute  col-12" >
                    <div class="container" style="max-width: 1156px">
                        <div class="col-12 p-0" >
            ...
            <div class="navhover h-100">
                <a href="<?php echo url('404'); ?>" class="text-white font-size-18 font-weight-light h-100 d-block px-4 " style="line-height: 75px">特色项目</a>
                <div class="secondnav container-fluid position-absolute  col-12" >
                    <div class="container" style="max-width: 1156px">
                        <div class="col-12 p-0" >
