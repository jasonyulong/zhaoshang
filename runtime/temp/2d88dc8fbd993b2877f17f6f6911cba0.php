<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\www\zhaoshang\application\..\public\tpl\admin\lou\add.html";i:1543388811;s:45:"D:\www\zhaoshang\public\tpl\admin\layout.html";i:1528875057;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" method="post" enctype="multipart/form-data" id="form" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="lx" placeholder="%">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">物业费</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="wuye" placeholder="㎡">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">楼盘名称</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="panname" placeholder="楼盘名称">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">地址</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="address" placeholder="地址">
        </div>
    </div>
