<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\www\zhaoshang\application\..\public\tpl\user\cang\article.html";i:1541991129;s:44:"D:\www\zhaoshang\public\tpl\user\layout.html";i:1542251356;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
    ...
    <div id="main">
        ...
        <section style="padding: 30px 15px 0px 15px;display: flex">
            <div class="setingleft">
                ...
                <a href="<?php echo url('user/cang/article'); ?>" class="p-link active">新闻收藏</a>
                <a href="<?php echo url('user/cang/fang'); ?>" class="p-link ">厂房收藏</a>
                ...
                <div class="new-wrap">
                    ...
                    <div class="super">
                        <a href="" class="porject">
                            ...
                            <p class="data"><?php echo date('Y-m-d H:i:s',$vo['time']); ?></p>
                            <blockquote><?php echo $vo['content']; ?></blockquote>
                        </a>
                    </div>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <p style="position: relative">
                    <span></span><strong>推荐新闻</strong>
