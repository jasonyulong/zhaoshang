<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\www\zhaoshang\application\..\public\tpl\admin\mall\add.html";i:1543388232;s:45:"D:\www\zhaoshang\public\tpl\admin\layout.html";i:1528875057;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" method="post" enctype="multipart/form-data" id="form" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input id='lnglat' type="text" name="map" value="116.611279,40.113257">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="addtime" placeholder="">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">商业建筑面积</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="jianzhu" placeholder="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="lou" placeholder="">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="gaikuang"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">项目分析</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="fenxi"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
