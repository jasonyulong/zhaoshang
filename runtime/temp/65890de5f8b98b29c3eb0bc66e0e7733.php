<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\www\zhaoshang\application\..\public\tpl\user\index\find.html";i:1542678151;s:44:"D:\www\zhaoshang\public\tpl\user\layout.html";i:1542251356;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
    ...
    <div id="main">
        ...
        <section style="padding: 30px 15px 0px 15px;display: flex">
            <div class="setingleft">
                ...
                <a href="<?php echo url('user/index/find_tudi'); ?>" class="p-link   active">土地求租求购</a>
                <a href="<?php echo url('user/index/find_fang'); ?>" class="p-link">厂房求租求购</a>
            ...
            <div class="setingrigth" style="background-color: white">
                <div class="changebtn" style="">
                    <button  class="active">土地求租</button>
                    <button >土地需求</button>
                </div>
                <div class="change" style="display: block">
                    ...
                    <p class="list" >
                        ...
                        <a href="set-tudi-info.html" ><?php echo $vo['title']; ?></a>
                ...
                <div class="new-wrap">
                    ...
                    <div class="super">
                        <a href="<?php echo url('index/Tudi/info',['id'=>$vo['id']]); ?>" class="porject">
                            <img src="<?php echo $vo['pic']; ?>" alt="" width="210" height="174">
                            <p><?php echo $vo['title']; ?></p>
                        </a>
                        <a href="<?php echo url('index/Tudi/info',['id'=>$vo['id']]); ?>" class="gz">立即关注</a>
                    </div>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
