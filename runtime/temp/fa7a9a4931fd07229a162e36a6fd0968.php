...
<a href="<?php echo url('index/zhaoshang/friend'); ?>" id="zhaoshang_friend">合作名企</a>
        ...
        <div class="prolist">
            <div class="listleft">
                ...
                <a href="<?php echo url('index/Lou/info',['id'=>$vo['id']]); ?>" class="items">
                    <div class="img-box">
                    ...
                    <div class="msg">
                        ...
                        <article>
                            ...
                            <div>
                                ...
                                <span>租金：<?php echo $vo['zujing']; ?>元</span>
            ...
            <div class="listright">
                <div class="weituo">
                    <a href="<?php echo url('index/zhaoshang/xuqiu',['type'=>'lou']); ?>">
                    ...
                    <a href="<?php echo url('index/zhaoshang/fabu',['type'=>'lou']); ?>">
