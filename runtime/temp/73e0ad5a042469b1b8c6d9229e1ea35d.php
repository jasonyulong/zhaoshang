<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\www\zhaoshang\application\..\public\tpl\admin\mall\edit.html";i:1543388807;s:45:"D:\www\zhaoshang\public\tpl\admin\layout.html";i:1528875057;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" method="post" enctype="multipart/form-data" id="form" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="hangye" id="hangye" class="isselect" lay-ignore>
                <?php if(is_array($dic['mall_hangye']) || $dic['mall_hangye'] instanceof \think\Collection || $dic['mall_hangye'] instanceof \think\Paginator): $i = 0; $__LIST__ = $dic['mall_hangye'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="addtime" placeholder="" value="<?php echo $info['addtime']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">商业建筑面积</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="jianzhu" placeholder="" value="<?php echo $info['jianzhu']; ?>">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName" name="lou" placeholder="" value="<?php echo $info['lou']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="gaikuang"><?php echo $info['gaikuang']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">项目分析</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="fenxi"><?php echo $info['fenxi']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
