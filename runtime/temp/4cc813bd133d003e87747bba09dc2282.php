<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\www\zhaoshang\application\..\public\tpl\index\dj\newsinfo.html";i:1542848111;s:36:"../public/tpl/index/include_nav.html";i:1542852579;s:31:"../public/tpl/index/footer.html";i:1543285728;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        #xm-info{padding: 20px 85px}
        #xm-info>h1{padding: 0 25px;font-size: 18px;color: #333333;font-weight: bold;text-align: center;line-height: 30px}
        #xm-info>p{padding: 10px 0}
        #xm-info>blockquote{line-height: 30px;padding: 30px 25px}
    </style>
</head>
<body>
...
<div class="mainwrap">
    <div id="main">
        ...
        <div id="xm-info">
            ...
            <p class="text-center" >发布时间 : <?php echo $info['time']; ?> 浏览次数 : <?php echo $info['look']; ?></p>
            <div class="line"></div>
            <blockquote><?php echo $info['content']; ?></blockquote>
        </div>
    </div>
</div>
