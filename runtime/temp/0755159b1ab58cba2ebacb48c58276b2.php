<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\www\zhaoshang\application\..\public\tpl\user\cang\tudi.html";i:1541991720;s:44:"D:\www\zhaoshang\public\tpl\user\layout.html";i:1542251356;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
    ...
    <div id="main">
        ...
        <section style="padding: 30px 15px 0px 15px;display: flex">
            <div class="setingleft">
                ...
                <a href="<?php echo url('user/cang/tudi'); ?>" class="p-link active">土地收藏</a>
