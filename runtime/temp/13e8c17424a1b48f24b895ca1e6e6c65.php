<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/opt/web/zhaoshang/application/../public/tpl/admin/article/sort_edit.html";i:1528875060;s:47:"/opt/web/zhaoshang/public/tpl/admin/layout.html";i:1547602823;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form method="post" class="layui-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input newsName"  name="name" value="<?php echo $info['name']; ?>" placeholder="输入分类名">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
