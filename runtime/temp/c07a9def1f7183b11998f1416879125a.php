<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\www\zhaoshang\application\..\public\tpl\index\index\getpwd.html";i:1541125338;}*/ ?>
<!DOCTYPE html>
<html lang="UTF8">
<head>
    <meta charset="UTF-8">
...
<div id="main">
    ...
    <form id="login" method="post">
        ...
        <div class="form-group">
            ...
            <input type="email" placeholder="输入登陆邮箱" name="email" autocomplete="off" email="true" maxlength="30" required="true">
        </div>
        <div class="errormsg"></div>
        <div class="form-group">
            <div class="ico">
        ...
        <div class="form-group" style="justify-content: space-between">
            <input type="submit" value="立即找回" style="width: 100%"></article>
        </div>
    </form>
    <footer>
