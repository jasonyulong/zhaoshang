(function () {
    function initcity(city) {
        switch (document.getElementById('province0').value) {
            case "安徽":
        ...
        for (var i = 0; i < cityOptions.length / 2; i++) {
            document.getElementById('city0').options[i] = new Option(cityOptions[i * 2],cityOptions[i * 2 + 1]);
            if (document.getElementById('city0').options[i].value == city) {
                document.getElementById('city0').selectedIndex = i;
            }
        }
    }
    function creatprovince(province) {
        ...
        document.getElementById('province0').options[0] = new Option("选择省份","");
        for (var i = 0; i < provinces.length; i++) {
            document.getElementById('province0').options[i + 1] = new Option(provinces[i],provinces[i]);
            if (document.getElementById('province0').options[i + 1].value == province) {
                document.getElementById('province0').selectedIndex = i + 1;
            }
        }
    }
    window.onload = function() {
        creatprovince();
        document.getElementById('city0').options[0] = new Option('选择城市',"")
    }
    document.getElementById('province0').addEventListener("change", initcity, false);
})()